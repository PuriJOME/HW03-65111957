...
class _AddEditUserState extends State<AddEditUser> {
  ...
  Widget buildInputField(String label, String? initialValue,
      Function(String?) onSave, IconData icon) {
    return Focus(
      child: Builder(
        builder: (context) {
          ...
          return TextFormField(
            ...
            obscureText: label == 'Password'
                ? true
                : false, // ซ่อน password โดยไม่มีไอคอน
      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              buildInputField('Full Name', _user.fullname,
                  (value) => _user.fullname = value, Icons.person),
              buildInputField('Email', _user.email,
                  (value) => _user.email = value, Icons.email),
              buildInputField('Password', _user.password,
                  (value) => _user.password = value, Icons.lock),
              buildGenderField(),
